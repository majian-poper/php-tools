...
describe('CommaSeparatedValues with offset, limit combinations', function () {
    ...
    describe('skip empty row', function () {
        test('offset 0, limit 0 - returns all data rows', function (CommaSeparatedValues $csv) {
        ...
        test('offset 0, limit 1 - returns first data row only', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => true,
                CommaSeparatedValues::OPTION_OFFSET => 0,
        ...
        test('offset 1, limit 0 - skips first data row, returns rest', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => true,
        ...
        test('offset 1, limit 1 - skips first, returns second data row only', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => true,
                CommaSeparatedValues::OPTION_OFFSET => 1,
                CommaSeparatedValues::OPTION_LIMIT => 1,
        ...
        test('offset 15 (exceeds total) - returns empty', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => true,
    ...
    describe('not skip empty row', function () {
        test('offset 0, limit 0 - returns all rows including empty rows', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
        ...
        test('offset 0, limit 1 - returns first row (data row)', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => false,
                CommaSeparatedValues::OPTION_OFFSET => 0,
                CommaSeparatedValues::OPTION_LIMIT => 1,
        ...
        test('offset 1, limit 0 - skips first row, returns rest', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => false,
                CommaSeparatedValues::OPTION_OFFSET => 1,
                CommaSeparatedValues::OPTION_LIMIT => 0,
        ...
        test('offset 1, limit 1 - skips first, returns second row (Bob)', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => false,
                CommaSeparatedValues::OPTION_OFFSET => 1,
                CommaSeparatedValues::OPTION_LIMIT => 1,
        ...
        test('offset 20 (exceeds total) - returns empty', function (CommaSeparatedValues $csv) {
            $rows = \iterator_to_array($csv->readRow([
                CommaSeparatedValues::OPTION_SKIP_EMPTY_ROW => false,
